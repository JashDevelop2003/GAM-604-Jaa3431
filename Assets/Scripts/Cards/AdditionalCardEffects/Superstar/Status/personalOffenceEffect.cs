...
public class personalOffenceEffect : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        statusCard.additionalEvent += PersonalOffence;
    ...
    // Personal Offence Increases Thrust by 5%
    public void PersonalOffence(object sender, EventArgs e)
    {
